    ...
    private void applyUI(){
        ...
        switch (windowState) {
            ...
            case STARTSCREEN:
                ...
                font = new Font("Arial", Font.BOLD, (int) (this.getWidth() * 0.03));
                graphics.setFont(font);
                graphics.drawString("If you skip this amazing startscreen by", getWidth() / 2 - (int) (this.getWidth() * 0.24), getHeight() / 2 + (int) (this.getHeight() * 0.15));
                ...
                graphics.drawString("Alien Arena Shootout", getWidth() / 2 - (int) (this.getWidth() * 0.24), getHeight() / 2 - (int) (this.getHeight() * 0.15));
                graphics.drawString("press any key to start the game", getWidth() / 2 - (int) (this.getWidth() * 0.3), getHeight() / 2 - (int) (this.getHeight() * 0.15 - this.getHeight() * 0.05));
                font = new Font("Arial", Font.PLAIN, (int) (this.getWidth() * 0.022));
                graphics.setFont(font);
                int i = 1;
