    ...
    private void applyUI(){
        ...
        switch (windowState) {
            ...
            case STARTSCREEN:
                ...
                graphics.fillRect(0, 0, getWidth(), getHeight());
                graphics.setColor(Color.WHITE);
                font = new Font("Arial", Font.BOLD, (int) (this.getWidth() * 0.025));
                graphics.setFont(font);
                graphics.drawString("If you skip this amazing startscreen by", getWidth() / 2 - (int) (this.getWidth() * 0.24), getHeight() / 2 + (int) (this.getHeight() * 0.35 - this.getHeight() * 0.05));
                graphics.drawString("pressing a key im go to f@cking murder you :)", getWidth() / 2 - (int) (this.getWidth() * 0.3), getHeight() / 2  + (int) (this.getHeight() * 0.35 ));
                font = new Font("Arial", Font.BOLD, (int) (this.getWidth() * 0.055));
                graphics.setFont(font);
                graphics.setColor(Color.RED);
                graphics.drawString("Alien Arena Shootout", getWidth() / 2 - (int) (this.getWidth() * 0.11), getHeight() / 2 - (int) (this.getHeight() * 0.15));
                graphics.setColor(Color.WHITE);
                font = new Font("Arial", Font.PLAIN, (int) (this.getWidth() * 0.022));
                graphics.setFont(font);
                int i = 1;
